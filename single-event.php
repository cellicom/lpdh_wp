                        ...
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                ...
                                <div
                                    ...
                                    <?php if ($event_date): ?>
                                        <div class="event-date">
                                            <i class="fas fa-calendar-alt me-1 text-lpdh-blue"></i>
                                                ...
                                                foreach ($rankings as $index => $rank):
                                                    ...
                                                    if ($player_deck_id) {
                                                        ...
                                                        if ($cmdr_img_url && $partner_img_url) {
                                                            ...
                                                            $icon_html = '<div class="position-relative overflow-hidden rounded-circle split-icon-container">';
                                                            $icon_html .= '<img src="' . esc_url($cmdr_img_url) . '" class="split-icon-half split-icon-left">';
                                                            $icon_html .= '<img src="' . esc_url($partner_img_url) . '" class="split-icon-half split-icon-right">';
                                                            $icon_html .= '</div>';
                                                            ...
                                                            // Only Commander
                                                            $icon_html = '<img src="' . esc_url($cmdr_img_url) . '" class="rounded-circle split-icon-container" style="object-fit: cover;">';
                                                ...
                                                <form id="deck-selection-form">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="deck-select" name="deck_id">
                                                            <option value="">
                                                                <?php esc_html_e('-- Select Deck --', 'bootscore'); ?></option>
                                                            <?php foreach ($current_user_decks as $deck): ?>
                                                                <option value="<?php echo esc_attr($deck->ID); ?>">
                                                                    <?php echo esc_html($deck->post_title); ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </form>
                            ...
                            <?php else: ?>
                                <div class="event-survey mb-5 p-4 bg-light rounded border text-center">
                                    ...
                                    <?php if (!$is_event_closed): ?>
                                        <p class="small mb-0">
                                            <?php esc_html_e('Log in to confirm your participation.', 'bootscore'); ?></p>
                                    <?php else: ?>
                                        <p class="small mb-0 text-danger">
                                            <?php esc_html_e('Registrations are closed.', 'bootscore'); ?></p>
                                    <?php endif; ?>
