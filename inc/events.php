    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'name' => 'event_type',
                'type' => 'select',
                'instructions' => 'Select the type of the event.',
                'required' => 1,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '50',
            ...
            array(
                ...
                'name' => 'format',
                'type' => 'select',
                'instructions' => 'Select the format of the event.',
                'required' => 1,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '50',
            ...
            array(
                'key' => 'field_ticket_fee',
                'label' => 'Ticket Fee',
                'name' => 'ticket_fee',
                'type' => 'text',
                'instructions' => 'Enter the ticket fee/entry price.',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '50',
                ...
                'default_value' => '5',
                'placeholder' => 'e.g. 5, Gratuito',
                'prepend' => '',
                'append' => '',
                'maxlength' => '',
            ),
            array(
                'key' => 'field_max_players',
                'label' => 'Max Players',
                'name' => 'max_players',
                'type' => 'number',
                'instructions' => 'Enter maximum number of players allowed (0 for unlimited).',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '50',
