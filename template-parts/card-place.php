        ...
        <div class="col-md-4 position-relative bg-light d-flex align-items-center justify-content-center">
            <a href="<?php the_permalink(); ?>" class="d-block w-100 text-decoration-none text-center">
                <?php if (has_post_thumbnail()): ?>
                    <div class="p-3">
                        <?php the_post_thumbnail('large', array('class' => 'img-fluid place-card-img')); ?>
                    </div>
                <?php else: ?>
                    <div class="bg-light d-flex align-items-center justify-content-center h-100 place-card-placeholder">
