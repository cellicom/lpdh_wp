            ...
            <div class="event-meta small d-flex flex-column flex-grow-1">
                ...
                <?php if ($formatted_date): ?>
                    <div class="event-time mb-2">
                        <i class="fas fa-calendar-alt me-2 text-lpdh-blue"></i>
