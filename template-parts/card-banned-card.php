        ...
        <div class="row g-0">
            <div class="col-4 col-sm-3 bg-light d-flex align-items-center justify-content-center">
                ...
                if (has_post_thumbnail()) {
                    $image_html = get_the_post_thumbnail(null, 'medium', array('class' => 'img-fluid rounded-start banned-card-img'));
                } else {
                    ...
                    if (!empty($scryfall_image_url) && $scryfall_image_url !== 'error') {
                        $image_html = '<img src="' . esc_url($scryfall_image_url) . '" class="img-fluid rounded-start p-2 banned-card-img" alt="' . esc_attr(get_the_title()) . '">';
                    }
                }
