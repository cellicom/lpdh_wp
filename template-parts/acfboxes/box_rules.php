                        ...
                        <div
                            ...
                            <?php if ($icon) { ?>
                                <div class="position-absolute top-0 start-50 translate-middle z-1">
                                    <div
                                        class="bg-white rounded-circle shadow-sm d-flex align-items-center justify-content-center rules-icon-bg">
                                        <img src="<?php echo esc_url($icon); ?>" alt="" class="rules-icon">
                                    </div>
                                </div>
                            <?php } ?>
                                                ...
                                                <li class="mb-2">
                                                    <?php if ($url && $link_inline) { ?>
                                                        <a target="_blank" rel="noopener noreferrer" href="<?php echo esc_url($url); ?>"
                                                            class="text-decoration-none text-body fw-medium"><?php echo wp_kses_post($text); ?></a>
                                                    <?php } else { ?>
