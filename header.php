    ...
    <nav id="nav-main" class="navbar <?= esc_attr(apply_filters('bootscore/class/header/navbar/breakpoint', 'navbar-expand-lg')); ?>">
      ...
      <div class="<?= esc_attr(apply_filters('bootscore/class/container', 'container', 'header')); ?>">
        ...
        <a class="<?= esc_attr(apply_filters('bootscore/class/header/navbar-brand', 'navbar-brand')); ?>" href="<?= esc_url(home_url()); ?>">
          <img src="<?= esc_url(apply_filters('bootscore/logo', get_stylesheet_directory_uri() . '/assets/img/logo/logo-lpdh-ext-transparent.png', 'default')); ?>" alt="<?= esc_attr(get_bloginfo('name')); ?> Legendary Pauper Commander" class="d-td-none">
          <img src="<?= esc_url(apply_filters('bootscore/logo', get_stylesheet_directory_uri() . '/assets/img/logo/logo-lpdh-ext-transparent.png', 'theme-dark')); ?>" alt="<?= esc_attr(get_bloginfo('name')); ?> Legendary Pauper Commander" class="d-tl-none">
        </a>  
